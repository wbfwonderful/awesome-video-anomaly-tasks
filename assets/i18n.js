...
const TEXT = {
  en: {
    ...
    "presentation.highlight": "Highlight",
    "common.yes": "Yes",
    "common.no": "No",
    "common.none": "-",
    "empty.noDerivedDatasets": "No derived benchmarks yet.",
    "empty.noMatchingPapers": "No matching papers.",
    "empty.noPaperResults": "No results found for this paper.",
    "empty.unknownPaper": "Unknown paper.",
  ...
  "zh-CN": {
    ...
    "empty.noPaperResults": "这篇论文暂无结果。",
    "empty.unknownPaper": "未知论文",
